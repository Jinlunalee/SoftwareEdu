...
public class EnrollVO {
	...
	private String stateCd;				// 수강 상태 공통 코드
	private int completeHours;			// 수강 완료 시간
	private String enrollDt;			// 수강 신청 일시
	private String regId;				// 수강 등록 아이디
	private String regDt;				// 수강 등록 일자
	private String modiId;				// 수강 변경 아이디
	private String modiDt;				// 수강 변경 일시
	private String delYn;				// 수강 삭제 여부
	private String cancelRsCd;			// 수강 취소 공통 코드
	private String cancelRsEtc;			// 수강 취소 기타 사유
	...
	private String catSubjectCd;		// 강좌 분류 공통 코드
	private int days;					// 강좌 일수
	private int hours;					// 강좌 시수
	private String levelCd;				// 강좌 난이도 공통 코드
	...
	private String openStateCd;			// 개설 강좌 상태 공통 코드
	
	// 수강생
	private String name;				// 수강생 명
	private String birth;				// 수강생 생년월일
    private String genderCd;			// 수강생 성별 공통 코드
    private String email;				// 수강생 이메일
    private String phone;				// 수강생 전화번호
    private String addDoCd;				// 수강생 주소 공통 코드
    private String addEtc;				// 수강생 주소 기타
    private String positionCd;			// 수강생 구분 공통 코드
    ...
    // 공통
	private String stateCdTitle;		// 수강 상태 공통 코드명
	private String cancelRsTitle;		// 수강 취소 공통 코드명
	private String catSubjectCdTitle;	// 강좌 분류 공통 코드명
	private String levelCdTitle;		// 강좌 난이도 공통 코드명
	private String openStateCdTitle;	// 개설 강좌 상태 공통 코드명
	private String genderCdTitle;		// 수강생 성별 공통 코드명
	private String addDoCdTitle;		// 수강생 주소 공통 코드명
	private String positionCdTitle;		// 수강생 구분 공통 코드명
