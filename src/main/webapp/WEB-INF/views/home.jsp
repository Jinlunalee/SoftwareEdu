...
<div class="main-second-row">
	<div class="main-second-row-btn level">
		...
		<div class="level-content">
			...
			<div class="level-content-item"><a href="<c:url value='/subject/subjectboardlist?catSubjectCd=SUB01'/>"><img id="second_image" src="<c:url value='/resources/images/main/main_programming.jpg'/>" style="display:block;"/>프로그래밍</a></div>
			<div class="level-content-item"><a href="<c:url value='/subject/subjectboardlist?catSubjectCd=SUB02'/>"><img id="second_image" src="<c:url value='/resources/images/main/main_bigdata.png'/>" style="display:block;"/>빅데이터</a></div>
			<div class="level-content-item"><a href="<c:url value='/subject/subjectboardlist?catSubjectCd=SUB03'/>"><img id="second_image" src="<c:url value='/resources/images/main/main_ai.jpg'/>" style="display:block;"/>AI</a></div>
